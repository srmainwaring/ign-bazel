...
def curl():
    native.new_local_repository(
        name = "curl",
        path = "/usr/local/opt/curl/include",
...
def ffmpeg():
    native.new_local_repository(
        name = "ffmpeg",
        path = "/usr/local/include/x86_64-linux-gnu",
...
def freeimage():
    native.new_local_repository(
        name = "freeimage",
        path = "/usr/local/opt/freeimage/include",
...
def gts():
    native.new_local_repository(
        name = "gts",
        path = "/usr/local/opt/gts/include",
...
def json():
    native.new_local_repository(
        name = "json",
        path = "/usr/local/opt/jsoncpp/include",
...
def sqlite3():
    native.new_local_repository(
        name = "sqlite3",
        path = "/usr/local/opt/sqlite3/include",
...
def yaml():
    native.new_local_repository(
        name = "yaml",
        path = "/usr/local/opt/yaml-cpp/include",
...
def libzip():
    native.new_local_repository(
        name = "zip",
        path = "/usr/local/opt/libzip/include",
...
def cppzmq():
    native.new_local_repository(
        name = "cppzmq",
        path = "/usr/local/opt/cppzmq/include",
        build_file = "//ign_bazel/third_party:cppzmq.BUILD",
    )

def zmq():
    native.new_local_repository(
        name = "zmq",
        path = "/usr/local/opt/zeromq/include",
